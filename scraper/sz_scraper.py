...
class SZScraper(InformalScraperInterface):
    ...
    def commentSectionExists(self, driver):
        commentSectionButtonXpath = "//button[@class='css-k61hmy' and contains(@title, 'Kommentare anzeigen')]"
    ...
    def getCommentDate(self, comment):
        timestamp = comment.find_element(By.XPATH,
                                         ".//span[@class='CommentTimestamp__timestamp___2Ejbf talk-comment-timestamp TimeAgo__timeago___3aHze talk-comment-timeago']").get_attribute(
            "title")
    ...
    def createCommentDf(self, commentWrapper, date):
        ...
        if isNewComment or scrapeUpdateReactions or scrapeCommentResponses:
            ...
            if scrapeUpdateReactions:
                likes = comment.find_element(By.XPATH, ".//span[@class='talk-plugin-sz-like-count']").text
                if likes == "":
                    likes = 0
            ...
            newComment = pd.DataFrame([{"cid": commentId, "parentid": parentId, "username": userName,
                                        ...
                                        "likes": likes, "stars": None, "hearts": None,
                                        "smiles": None, "frowns": None, "eyebrows": None, "astonisheds": None}])
        return newComment
