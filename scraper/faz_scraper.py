    ...
    def createCommentDf(self, commentWrapper, date):
        ...
        if isNewComment or scrapeUpdateReactions or scrapeCommentResponses:
            ...
            if scrapeUpdateReactions:
                ...
                if upvotes == "":
                    upvotes = 0
                downvotes = comment.find_element(By.XPATH, ".//span[@class='talk-plugin-downvote-count']").text
                if downvotes == "":
                    downvotes = 0
                loves = comment.find_element(By.XPATH, ".//span[@class='talk-plugin-love-count']").text
                if loves == "":
                    loves = 0
